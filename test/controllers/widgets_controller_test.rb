...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { injected_content: @widget.injected_content, name: @widget.name, url: @widget.url } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { injected_content: @widget.injected_content, name: @widget.name } }
